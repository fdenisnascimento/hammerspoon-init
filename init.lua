...
local main_monitor = "iMac"
local second_monitor = "DELL P1917S"
...
local layouts = {
  {
    name = { "iTerm2","Atom","Firefox","Airmail", "Mail", "Calendar", "iTunes", "Last.fm Scrobbler", "Messages", "Skype", "Dash"},
    func = function(index, win)
  ...
  {
    name = {"Cocoa Rest Client", "Yummy FTP Pro","Postman"},
    func = function(index, win)
      if (#hs.screen.allScreens() > 1) then
        win:moveToScreen(hs.screen.get(second_monitor))
  ...
  {
    name = {"Evernote", "JSON Accelerator", "Preview", "Slack", "Franz", "Safari"},
    func = function(index, win)
      if (#hs.screen.allScreens() > 1) then
        win:moveToScreen(hs.screen.get(second_monitor))
        hs.window.fullscreenCenter(win)
  ...
  {
    name = {"Xcode", "SourceTree", "Android Studio"},
    func = function(index, win)
      if (#hs.screen.allScreens() > 1) then
        win:moveToScreen(hs.screen.get(second_monitor))
